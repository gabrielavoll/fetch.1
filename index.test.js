...
const base_test_url = 'https://desolate-anchorage-36928.herokuapp.com/';
...
test('get, allows you to alter cookies by default', async () => {
	const initial = await my_module.get(base_test_url);
 	...
 	const response = await my_module.get(base_test_url + "api");
...
test('post, allows you to alter cookies by default', async () => {
  const initial = await my_module.get(base_test_url);
 	...
 	const response = await my_module.post(base_test_url + "api");
...
test('put, allows you to alter cookies by default', async () => {
 const initial = await my_module.get(base_test_url);
 	...
 	const response = await my_module.put(base_test_url + "api");
...
test.skip('postNoCookies', async () => {
 	const response = await my_module.postNoCookies(base_test_url);
 	expect(response.ok).toBe(true)

});
test.skip('putNoCookies', async () => {
 	const response = await my_module.putNoCookies(base_test_url);
 	expect(response.ok).toBe(true)
});